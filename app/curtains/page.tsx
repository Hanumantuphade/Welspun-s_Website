...
export default function CurtainsPage() {
  ...
  <div className="min-h-screen bg-white">
    ...
    {/* Hero Section */}
    <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] flex items-center justify-center text-center">
      ...
      <div className="relative z-20 px-4 sm:px-6 md:px-10 text-white max-w-3xl">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-100 leading-relaxed mb-4">
          ...
          <span className="text-xs sm:text-sm text-gray-100">Over 3400 premium designs in sheer, blackout, velvet, and more.</span>
        </p>

        <div className="bg-white/10 backdrop-blur-md rounded-lg p-4 sm:p-6 text-left text-white shadow-lg max-w-2xl mx-auto">
          <h2 className="text-base sm:text-lg font-semibold mb-3">Available Fabrics</h2>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-1 sm:gap-2 text-sm list-disc list-inside">
            <li>Sheer</li>
            <li>Velvet</li>
          ...
          <p className="mt-3 text-sm italic text-gray-100">Over 3400+ designs available</p>
        </div>
      </div>
    </div>
        ...
        <div className="flex-1">
          ...
          {products.length === 0 && !loading && (
            <div className="text-center py-16">
              ...
              <h3 className="text-base font-medium text-gray-900 mb-2">No curtains found</h3>
              <p className="text-sm text-gray-500 mb-4">Check back soon for new curtain products!</p>
              <button 
                onClick={() => window.location.reload()} 
