...
const demoProducts = [
  {
    ...
    price: "₹1299",
    description: "Demo product - Stay cosy with this warm embrace blanket crafted for ultimate comfort.",
  },
  {
    id: 988,
    ...
    price: "₹1599",
    description: "Demo product - Add luxury to your sleep with this premium blanket made from finest materials.",
  },
];
...
export default function BlanketsPage() {
  ...
  useEffect(() => {
    const fetchBlanketProducts = async () => {
      try {
        setLoading(true);
        setError(null);

        const response = await fetch('/api/products/category/blankets');
        ...
        const transformedApiProducts: ProductGridItem[] = apiProducts.map(product => ({
          ...
          description: product.description || `Premium ${product.name.toLowerCase()} crafted for warmth and comfort in all seasons.`
        }));
        ...
        console.error('Error fetching blanket products:', err);
    ...
    return (
      ...
      >
        <div className="text-center py-20">
          ...
          <p className="text-gray-600">Loading blanket products...</p>
        </div>
      </PageLayout>
    );
  }
    ...
    >
      ...
      <div className="mb-6 text-center">
        <p className="text-gray-600">
          Showing {products.length} blanket product{products.length !== 1 ? 's' : ''}
      ...
      {products.length > 0 ? (
        ...
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No blanket products found</h3>
          <p className="text-gray-500 mb-4">
            {error 
              ? 'Unable to load products. Please try again later.' 
              : 'Check back soon for new blanket products!'
            }
          </p>
